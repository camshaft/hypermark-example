...
DEPS = hypermark hypermark_cowboy_http hypermark_hyperjson_serializer hypermark_collectionjson_serializer hypermark_haljson_serializer

dep_hypermark = pkg://hypermark master
dep_hypermark_cowboy_http = pkg://hypermark_cowboy_http master
